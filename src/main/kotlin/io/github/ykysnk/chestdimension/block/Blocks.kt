...
object Blocks {
    ...
    val CHEST_PLATFORM: Block = register(
        "chest_platform",
        Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0f, 3.0f).sound(SoundType.WOOD))
    )
    ...
    val CHEST_DIMENSION: Block = register("chest_dimension", ChestDimensionBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0f, 600.0f).sound(SoundType.WOOD)))
}