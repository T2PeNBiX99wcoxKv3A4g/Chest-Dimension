...
data class BedrockPillarConfiguration(
    ...
    companion object {
        val CODEC: Codec<BedrockPillarConfiguration> = RecordCodecBuilder.create { instance ->
            instance.group(
                Codec.intRange(0, 64).fieldOf("min_pillars").forGetter(BedrockPillarConfiguration::minPillars),
                Codec.intRange(0, 64).fieldOf("max_pillars").forGetter(BedrockPillarConfiguration::maxPillars),
